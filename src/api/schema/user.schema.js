...
const userCreateSchema = Joi.object({
	...
	user_middle_name: Joi.string().max(255).allow(null, '').optional(),
	user_last_name: Joi.string().max(255),
	user_contact_person: Joi.string().max(255).allow(null, '').optional(),
	user_contact_no: Joi.number().integer(),
	user_address: Joi.string().max(255).allow(null, '').optional(),
...
const userUpdateSchema = Joi.object({
	...
	user_contact_no: Joi.number().integer().allow(null, '').optional(),
	user_address: Joi.string().max(255).allow(null, '').optional(),
	createdBy: Joi.string().max(255),
	updatedBy: Joi.string().max(255),
}).unknown(true);
