...
module.exports = (sequelize, DataTypes) => {
	const bas_quick_code = sequelize.define('bas_quick_code', {
		...
		qc_alternative_code1: { type: DataTypes.STRING(255), allowNull: false },
		qc_alternative_code2: { type: DataTypes.STRING(255), allowNull: false },
		qc_alternative_code3: { type: DataTypes.STRING(255), allowNull: false },
